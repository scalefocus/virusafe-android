...
import bg.government.virusafe.app.bluetooth.ProteGoManufacturerDataVersion
...
import bg.government.virusafe.app.bluetooth.advertisementByteLength
...
import bg.government.virusafe.app.bluetooth.toHexString
...
class ProteGoAdvertiser(
	...
	private fun startGattServer(): ServerResult {
		...
		return ProteGoGattServer.startGattServer(
				context,
				beaconIdAgent,
				this
			) { bluetoothManager.openGattServer(context, it) }
			.also {
				when (it) {
